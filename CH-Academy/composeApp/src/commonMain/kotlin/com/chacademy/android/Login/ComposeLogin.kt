...
import com.chacademy.android.getCipher
import com.chacademy.android.getPlatform
...
@Composable
fun ComposeLogin(loginModel: LoginViewmodel, loginState: LoginState) {
...
//
//                }
                errorMessage = loginState.userPassword.toString()
            }
        }
